                                    ...
                                    <div style={{ backgroundColor: '#fff', padding: 9, marginBottom: 7 }}>
                                        ...
                                        <div className="d-grid gap-2">
                                            ...
                                            {ShowItem && ShowItem.data.status == 10 &&
                                                <div className="box-note warning">
                                                    <p className="text">لقد تم رفض التعديل من طرف البائع في انتظار حل النزاع بينك وبين البائع . خلال 48 ساعة وإلا سيتم تصعيد المشلكة إلى خدمة العملاء مما قد يؤدي إلى حظر حسابك</p>
                                                </div>
                                            }
                                        </div>
                                    </div>
