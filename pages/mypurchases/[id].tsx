...
const Order = ({ query }) => {
    ...
    async function rattingHandle(id: any) {
        ...
        try {
            const res = await API.post(`api/order/items/${id}/rating`, {
                                                    ...
                                                    <motion.div initial={{ scale: 0, opacity: 0, y: 60 }} exit={{ scale: 0, opacity: 0, y: 60 }} animate={{ scale: 1, opacity: 1, y: 0 }} className="single-comments-modal">
                                                        <div className="modal-title">
                                                            ...
                                                            <button
                                                                className='btn-close'
                                                                type='button'
                                                                onClick={() => setModalVisibleRatting(false)}></button>
                                                        </div>
                                                        ...
                                                        <div className="modal-body">
                                                            ...
                                                            <hr />
                                                            <button className='btn butt-primary butt-sm mx-1' type='submit' onClick={() => rattingHandle(ShowItem && ShowItem.data.id)}>إضافة التعليق</button>
                                                            <button className='btn butt-red-text butt-sm mx-1' onClick={() => setModalVisibleRatting(false)} type='button'>إغلاق</button>
                                                        </div>
                                                    </motion.div>
                                                </div>
                                            }
                                    ...
                                    <div style={{ backgroundColor: '#fff', padding: 9, marginBottom: 7 }}>
                                        ...
                                        <div className="d-grid gap-2">
                                            ...
                                            {ShowItem && ShowItem.data.status == 10 &&
                                                <div className="box-note warning">
                                                    <p className="text">لقد تم رفض التعديل من طرف البائع في انتظار حل النزاع بينك وبين البائع . خلال 48 ساعة وإلا سيتم تصعيد المشكلة إلى خدمة العملاء</p>
                                                </div>
                                            }
                                        </div>
                                    </div>
