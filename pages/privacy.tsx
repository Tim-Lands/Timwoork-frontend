            ...
            <div className="container my-3">
                <div className="bg-white p-2 px-4">
                    ...
                    <div className="page-content">
                        <p className="text">تلتزم إدارة الموقع في حدود المسموح لها وفق القانون المنظم، بعدم كشف أي معلومات شخصية عن المستخدم مثل العنوان أو رقم الهاتف أو عنوان البريد الإلكتروني وغيرها. علاوة على ذلك، لن يتم تبادل، أو تداول أي من تلك المعلومات أو بيعها لأي طرف آخر طالما كان ذلك في حدود قدرات إدارة الموقع الممكنة، ولن يُسمح بالوصول إلى المعلومات إلا للأشخاص المؤهلين والمحترفين الذين يشرفون على موقع تيم ورك الإلكتروني.        </p>
                    </div>
                    <div className="page-content">
                        ...
                        الموقع الممكنة، ولن يُسمح بالوصول إلى المعلومات
                         إلا للأشخاص المؤهلين والمحترفين الذين يشرفون على موقع تيم ورك الإلكتروني.   
                        </p>
                    </div>
                    <div className="page-content">
                    ...
                    <div className="page-content">
                        ...
                        بعض أجزاء الموقع لا تفتح إلا للأعضاء المشتركين المسجلين بعد
                         ...
                         أكثر من حساب واحد في موقع تيم ورك وعند استخدام نفس الشخص
                    ...
                    <div className="page-content">
                        ...
                        <p className="text">
                        تحتفظ إدارة موقع تيم ورك الإلكتروني بالحق في
