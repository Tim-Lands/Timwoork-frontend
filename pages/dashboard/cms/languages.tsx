...
function Languages(): ReactElement {
    ...
    const refreshData = async () => {
        setIsLoading(true)
        try {
            const res: any = await API.get('dashboard/languages')
            if (res) {
                setIsLoading(false)
    ...
    const deleteHandle = (id) => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    try {
                        const res: any = API.post(`dashboard/languages/${id}/delete`)
                        //const json = res.data
                        if(res) {
                            refreshData()
                        }
...
export default connect(mapStateToProps, { logout })(Languages);
