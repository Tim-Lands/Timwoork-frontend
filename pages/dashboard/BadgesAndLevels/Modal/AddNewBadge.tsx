...
export default function AddNewBadge({ setIsModalHiddenHandle }): ReactElement {
        ...
        <>
            ...
            <div className="panel-modal modal-add-new">
                <div className="panel-modal-header">
                    <h2 className="title"><span className="material-icons material-icons-outlined">add_box</span>Add New Badge</h2>
