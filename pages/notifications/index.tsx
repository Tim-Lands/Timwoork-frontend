...
function index() {
    ...
    const { data: notifications }: any = useSWR(`api/notifications?page=${pageNumber}`)
        ...
        <div className="my-2 py-4">
            ...
            <div className="row justify-content-center">
                <div className="col-md-6">
                    ...
                    <Pagination
                  activePage={
                    notifications?.data?.current_page ? notifications?.data?.current_page : 0
                  }
                  itemsCountPerPage={
                    notifications?.data?.per_page ? notifications?.data?.per_page : 0
                  }
                  totalItemsCount={notifications?.data?.total ? notifications?.data?.total : 0}
                  onChange={(pageNumber) => {
