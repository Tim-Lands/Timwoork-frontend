...
function Explores() {
  ...
  const { data: categories, categoriesError }: any =
    useSWR("api/get_categories");
      ...
      <div className="col-md-4 p-0">
        <div className="main-explores">
          <ul className="main-explore-items">
            {categories &&
              categories.data.slice(0, 7).map((e: any, i) => (
                <motion.li
                  initial="hidden"
          ...
          {postsList && (
            <div className="main-explores-container">
              ...
              <div className="main-item-category-body">
                <div className="row">
                  {postsList &&
                    postsList.sub_categories &&
                    postsList.sub_categories.slice(0, 12).map((e: any) => (
                      <div className="col-sm-6" key={e.id}>
                        <a
                          href={`/products?categoryID=${e.parent_id}&subcategoryID=${e.id}`}
