            ...
            <div className="choose-images-list">
                <div className={"panel-modal-body login-panel-body auto-height"}>
                    ...
                    <div className="images-list-uploading align-center">
                        ...
                        <p className="text-resolotion" style={{ color: '#222', margin: 0, fontSize: 13, fontWeight: 'bold' }}>من الأفضل أن تكون الأبعاد: 750X450</p>
                        <ImageUploading
                                        ...
                                        {imageList && imageList.map((image, index) => (
                                            <div className="p-0" key={index}>
                                                <div
                                                    ...
                                                    style={{
                                                        backgroundImage: `url(${image['data_url']})`, backgroundSize: 'cover'
                                                    }}>
