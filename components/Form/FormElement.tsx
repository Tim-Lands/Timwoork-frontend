...
export function TextInput(props: any): ReactElement {
  const formClasses: string = `timlands-form ${
    props.errorMsg ? "form-error" : ""
  }`;
  const inputClasses: string = `timlands-input ${
    props.errorMsg ? "has-error" : ""
  }`;
  ...
  return (
    <div className={formClasses}>
      <label className="label-block" htmlFor={props.idName}>
        {props.title}
      </label>
      <input
