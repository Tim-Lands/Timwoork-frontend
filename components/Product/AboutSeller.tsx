                ...
                <div className="d-flex">
                    ...
                    <div className="seller-info-content">
                        ...
                        <ul className="user-meta nav">
                            <li>
                                <span className="material-icons material-icons-outlined">badge</span> {badge !== null && badge.name_ar}
                            </li>
                            {country !== null &&
                                <li>
                        ...
                        <div className="seller-info-butts d-flex">
                            ...
                            <a className="btn butt-green butt-sm flex-center" onClick={() => getOrCreateChat(email, userId, username)}>
