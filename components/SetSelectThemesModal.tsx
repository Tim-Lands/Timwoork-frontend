...
function SetSelectThemesModal({ setIsConfirmText, title }: any): ReactElement {
    return (
        <motion.div initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className='modal-conferm sub-modal md'>
            <div className="modal-conferm-inner">
                ...
                <div className="modal-conferm-body" style={{ paddingTop: 0 }}>
                    <p className="modal-note">يرجى اختيار احد القوالب المناسبة</p>
                    <div className="row">
                ...
                <div className="modal-conferm-footer">
                    <div className='d-flex'>
                        <div className="me-auto">
                            <button className='btn butt-sm butt-green mx-1' >تحديد الآن</button>
