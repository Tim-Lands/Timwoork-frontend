...
function DisactiveProductCause({ setIsConfirmText, handleFunc, title, msg, setMsg }): ReactElement {
    return (
        <motion.div initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className='modal-conferm'>
            <div className="modal-conferm-inner">
                ...
                <div className="modal-conferm-footer">
                    <Space>
                        <button className='btn butt-sm butt-green' onClick={() => handleFunc({ message: msg })}>تعطيل الآن</button>
